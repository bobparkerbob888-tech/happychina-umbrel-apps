...
const coins = {
  litecoin: {
    ...
    stratumPorts: [
      { port: 3331, diff: 2000000000, fixedDiff: true, label: 'Fixed Diff 2B (Huge rigs)' },
      { port: 3332, diff: 1000000, label: 'High Start 1M (Big rental rigs, vardiff + suggest_difficulty)' },
